...
void solve(long long N, long long M, std::vector<long long> A, std::vector<long long> X, std::vector<long long> Y, std::vector<long long> Z){
...
int main(){
    ...
    solve(N, M, std::move(A), std::move(X), std::move(Y), std::move(Z));
    return 0;
}
