...
void solve(long long N, long long Q, std::string S, std::vector<long long> a, std::vector<long long> b, std::vector<long long> c, std::vector<long long> d){
...
int main(){
    ...
    solve(N, Q, S, std::move(a), std::move(b), std::move(c), std::move(d));
    return 0;
}
